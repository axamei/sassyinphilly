...
gulp.task('styles', function () {
  return gulp.src('app/styles/main.scss')
    ...
    .pipe($.uncss({
      html: ['dist/index.html', 'dist/about/index.html', 'dist/contact/index.html', 'dist/blog/**/*.html'],
      ignore: ['.nav-collapse', '.nav-collapse ul', '.nav-collapse ul li', '.nav-collapse ul li a', '.nav-collapse.opened', '.js .nav-collapse', '.js .nav-collapse.closed', '.js .nav-collapse ul li a', '.nav-toggle', '.nav-toggle:hover']
    }))
    .pipe($.cssnano())
